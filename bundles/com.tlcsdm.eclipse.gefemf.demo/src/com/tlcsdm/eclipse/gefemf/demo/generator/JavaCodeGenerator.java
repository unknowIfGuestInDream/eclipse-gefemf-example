...
public class JavaCodeGenerator {
	...
	public String generateClass(ClassNode node) {
		...
		if (superClass != null) {
			sb.append("public class ").append(node.getClassName()).append(" extends ").append(superClass)
					.append(" implements Serializable {\n\n");
		} else {
			sb.append("public class ").append(node.getClassName()).append(" implements Serializable {\n\n");
		}
	...
	private void generateGetterSetter(StringBuilder sb, String attr) {
		...
		// Setter
		sb.append("    public void set").append(capName).append("(").append(type).append(" ").append(name)
				.append(") {\n");
